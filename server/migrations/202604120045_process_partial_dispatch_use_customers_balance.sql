-- process_partial_dispatch referenced public.customer_balances, which does not exist in this schema.
-- Running balance lives on public.customers.balance_due (see create_order / credit checks).
...
COMMENT ON FUNCTION public.process_partial_dispatch IS 'Dispatch via dispatch_records; customer AR balance on public.customers.balance_due; cap/product unit_type and factory matching per 202604120030';
