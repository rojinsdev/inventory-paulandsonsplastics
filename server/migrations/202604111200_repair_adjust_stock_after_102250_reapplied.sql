-- Repair: If 202604102250 was applied AFTER 202604102320 on production, it overwrote adjust_stock
-- with the INSERT-only version and removed the UPDATE-first / negative-deduction safety from 102320.
-- This file is idempotent: same body as 202604102320 — safe to run anytime prod needs the correct RPC.
