-- Fix: Cast text to inventory_state enum in prepare_order_items_atomic
-- The state column uses inventory_state enum type, not text
        ...
        IF v_product_id IS NOT NULL THEN
            ...
            LOOP
                ...
                INSERT INTO public.stock_balances (
                    ...
                    v_product_id, v_factory_id, v_to_reserve, 'reserved'::inventory_state, v_unit_type, 
        ...
        ELSIF v_cap_id IS NOT NULL THEN
            ...
            LOOP
                ...
                INSERT INTO public.cap_stock_balances (
                    ...
                    v_cap_id, v_factory_id, v_to_reserve, 'reserved'::inventory_state, 
