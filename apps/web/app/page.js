        ...
        <DashboardLayout title="Dashboard">
            ...
            <div className={styles.welcomeSection}>
                <div>
                    ...
                    <div className={styles.dateTimeDisplay}>
                        ...
                        <span>{currentDateTime.toLocaleTimeString('en-IN', {
                            hour: '2-digit',
                            minute: '2-digit'
                        })}</span>
                    </div>
            ...
            {(() => {
                const allMetrics = [
                    ...
                    { id: 'avgEfficiency', component: <MetricCard key="avgEfficiency" title="Avg Efficiency" value={`${production.averageEfficiency}%`} subtitle="Today's average" icon={TrendingUp} gradient="linear-gradient(135deg, #8b5cf6, #7c3aed)" /> },
                    ...
                    { id: 'stockValue', component: <MetricCard key="stockValue" title="Stock Value" value={formatCurrency(inventory.totalStockValue)} subtitle="Finished goods value" icon={DollarSign} gradient="linear-gradient(135deg, #8b5cf6, #7c3aed)" /> },
                    ...
                    { id: 'activeCustomers', component: <MetricCard key="activeCustomers" title="Active Customers" value={sales.activeCustomers} subtitle="Last 30 days" icon={Users} gradient="linear-gradient(135deg, #8b5cf6, #7c3aed)" /> },
                ];
